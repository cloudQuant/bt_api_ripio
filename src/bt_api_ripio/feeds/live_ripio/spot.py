...
class RipioRequestDataSpot(RipioRequestData):
    ...
    def _get_kline(self, symbol, period, count=100, from_time=None, to_time=None, extra_data=None, **kwargs):
    ...
    def get_kline(self, symbol, period, count=100, extra_data=None, from_time=None, to_time=None, **kwargs):
        path, params, extra_data = self._get_kline(symbol, period, count, from_time, to_time, extra_data, **kwargs)
        return self.request(path, params=params, extra_data=extra_data)

    def async_get_kline(self, symbol, period, count=100, extra_data=None, from_time=None, to_time=None, **kwargs):
        path, params, extra_data = self._get_kline(symbol, period, count, from_time, to_time, extra_data, **kwargs)
        self.submit(
            self.async_request(path, params=params, extra_data=extra_data),
            callback=self.async_callback,
